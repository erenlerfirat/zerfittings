...
function IndustrialCard() {
  const products = [
    { headerFirstLine: "Kaynaklı Fittings Malzemeler", img:img, path:"urunler/kaynakli-fittings" },
    { headerFirstLine: "Dişli Fittings Malzemeler", img:img2, path:"urunler/disli-fittings" },
  ];
